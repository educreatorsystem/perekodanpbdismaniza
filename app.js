const DATA_SHEET_ID = "1ur9KIJSl9mujZh2TPeRF2SvHoyfdTOLBWJpPNQDKLAQ";

const SHEET_URLS = {
  students:
    "https://docs.google.com/spreadsheets/d/e/2PACX-1vTfwelnHtpic6kFnWbC439gCAfq9Z-QB823ZiuUhgoRpFYAA5SwehodgYhwqe4FrMvlxV3Z-z3MgZXD/pub?gid=1626540029&single=true&output=csv",
  standards:
    "https://docs.google.com/spreadsheets/d/e/2PACX-1vTfwelnHtpic6kFnWbC439gCAfq9Z-QB823ZiuUhgoRpFYAA5SwehodgYhwqe4FrMvlxV3Z-z3MgZXD/pub?gid=0&single=true&output=csv",
  skills:
    "https://docs.google.com/spreadsheets/d/e/2PACX-1vTfwelnHtpic6kFnWbC439gCAfq9Z-QB823ZiuUhgoRpFYAA5SwehodgYhwqe4FrMvlxV3Z-z3MgZXD/pub?gid=429299684&single=true&output=csv",
};

const APPS_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbwoozAOmCzeJ3HTXk-XoPGoKZ8T8ZfGdJixUHgDh0J1DbD7oVc7-XATZ06-6wNjM_xjFw/exec";
      ...
      <head>
        ...
        <style>
          * { box-sizing: border-box; }
          ...
          .print-title h2 { font-size: 14px; line-height: 1.1; margin: 0; text-transform: uppercase; }
